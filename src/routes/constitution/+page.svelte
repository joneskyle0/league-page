...
<div class="constitution">
    ...
    <h3 class="noUnderscore clickable" onclick={() => goToSection(one)}>Section 1: Roster</h3>
        <h4 class="noUnderscore clickable" onclick={() => goToSection(oneOne)}>1.1 Positional Breakdown</h4>
            <h5 class="noUnderscore clickable" onclick={() => goToSection(oneOneOne)}>1.1.1 Taxi Squad</h5>
            <h5 class="noUnderscore clickable" onclick={() => goToSection(oneOneTwo)}>1.1.2 Position Maximums</h5>
