...
export const managers = [
    ...
    },
    {
      ...
      "name": "joshb32",
      "location": "Alma, MI", // (optional)
      "bio": "We’re Costco guys. Of course we’re going to eat a chicken bake while winning the championship. ",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
    ...
    },
    {
      ...
      "rival": {
        name: "Rival", // Can be anything (usually your rival's name)
        link: 4, // manager array number within this array, or null to link back to all managers page
        image: "/managers/jones.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
